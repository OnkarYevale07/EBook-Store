	...
	<div class="container p-3">
		<div class="row">
			<div class="col-md-6 text-center p-5 border bg-white">
				<img alt="book_image" src="book/<%=b.getPhotoName()%>"
			...
			<div class="col-md-6 text-center p-5 border bg-white">
				...
				<div class="text-center">
					...
					if (u == null) {
					%>
					<a href="login.jsp" class="btn btn-primary ml-5"><i class="fa-solid fa-cart-plus"></i>  Add Cart</a>
					<%
					} else {
					%>
					<a href="cart?bid=<%=b.getBookId()%>&&uid=<%=u.getId()%>"
						class="btn btn-primary ml-5">Add Cart</a>
					<%
					}
