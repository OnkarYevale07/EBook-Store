...
<div class="container-fluid p-3 bg-light">
	<div class="row">
		...
		<c:if test="${not empty userObj}">
			<div class="col-md-3">
			 <a href="checkout.jsp"
					class="btn text-primary"><i class="fa-solid fa-cart-plus fa-2x"></i></a>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="text-center">
					<h4>Do You Want Logout?</h4><br>
					<button type="button" class="btn btn-secondary"
						data-dismiss="modal">Close</button>
					<a href="logout" type="button" class="btn btn-primary ml-2">Logout</a>
				</div>
			</div>
